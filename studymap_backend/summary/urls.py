...
from .views import GenerateSummaryView, SummaryDetailView, export_summary
...
urlpatterns = [
    ...
    path('projects/<int:project_id>/summary/<int:summary_id>/export/', export_summary, name='export-summary'),
]